...
data_dir = '../data/AID/'
train_data = SkinCancer(data_dir, '../data/train.csv', transform=None)
dataset_size = len(train_data)    
test_data = SkinCancer(data_dir, '../data/test.csv',transform=None)
classes=np.unique(train_data.classes)

dataloader = torch.utils.data.DataLoader(train_data, batch_size=opt.batch_size)
...
def sample_image(n_row, batches_done):
    ...
    save_image(gen_imgs.data, "generated_images/%d.png" % batches_done, nrow=n_row, normalize=True)
